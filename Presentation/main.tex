...
\begin{frame}{Experimental Setup}{CNN}
	...
	\only<4-6>{\begin{figure}[H]
			\begin{subfigure}{.4\textwidth}
				\centering
				\includegraphics<4->[width=\textwidth]{GT_14.jpg}
			\end{subfigure}
			$\Rightarrow$
			\begin{subfigure}{.4\textwidth}
				\centering\includegraphics<4>[width=\textwidth]{GT_14_wo_cl_1}\includegraphics<5>[width=\textwidth]{GT_14_wo_cl_2}\includegraphics<6>[width=\textwidth]{GT_14_wo_cl_3}
			\end{subfigure}
		\end{figure}
	}
	\hfill	
...
% TODO leave out t-SNE altogether?
...
\subsection{Zurich Dataset}
	...
	\begin{table}[H]
		...
		\begin{tabular}{lllllll}
			...
			& \gls{OA} [\%]  & \gls{AA}  [\%] & \gls{OA} [\%]  & \gls{AA}  [\%] & \gls{OA} [\%]  & \gls{AA}  [\%]\\\midrule
			Mean  &  63.60 &  59.18 &  84.85 &  73.09 &  83.86 &  71.02 \\\bottomrule
		\end{tabular}
	\end{table}}
\end{frame}
% Average left-out model accuracies?
...
\begin{frame}{Novelty Detection}{Unseen Class \textbf{Water}}
	\begin{figure}[H]
		...
		\begin{subfigure}{0.49\textwidth}
			\caption{\acrlong{GT}}
			\pdfpxdimen=\dimexpr 1 in/255\relax
			\includegraphics<1->[clip, trim=0 0 0 600px, width=\textwidth]{GT_15}
		\end{subfigure}
		\begin{subfigure}{0.49\textwidth}
	...
	% TODO remove?
		\begin{figure}[H]
			...
			\begin{minipage}{.25\textwidth}
				\foreach \method/\captionname in {net_msr_im_#3/\gls{MSR},svm_im_#3_eq/\gls{OC-SVM},df_im_#3_eq/\gls{DF}}{
					\begin{subfigure}{\textwidth}
						\centering
						\pdfpxdimen=\dimexpr 1 in/255\relax
						\includegraphics[clip, trim=#5, width=\textwidth]{ZH_wo_cl_#1_\method}
						\caption{\captionname}
					\end{subfigure}
				}
			\end{minipage}\hfill
