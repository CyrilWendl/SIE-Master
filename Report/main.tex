...
\begin{figure}[H]
	...
	\foreach \dataset in {1,2,3}
	{
        ...
        \centering
        \includegraphics[width=\textwidth]{D\dataset_data-covs}
...
\begin{itemize}
	% DF
	\item \acrlongpl{DF} have been implemented and applied to a synthetic dataset as well as a more complex dataset consisting of high-dimensional neural network activations. Their potential for novelty detection in the \gls{MNIST} dataset and in the more complex Zurich dataset has been assessed and discussed.
	% Library
...
Further research should go into understanding the reasons for the inconsistent behavior of \acrlongpl{DF}. 
